...
export const PassPreviewCanvas: React.FC<PassPreviewCanvasProps> = ({
  ...
  }, [activeKind, info, e1Opts, frontPhotoUrl, cutoutPhotoUrl, customIconUrl, layers]);
    ...
    <div className="flex flex-col h-auto min-h-full bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-slate-800">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-bold text-white">实时效果预览</h3>
        </div>
      ...
      {/* Layer Debug Inspection Control Panel (Moved to bottom, 1 column) */}
      {showDebugLayers && (
